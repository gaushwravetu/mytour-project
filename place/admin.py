...
class PlaceAdmin(admin.ModelAdmin):
    ...
    list_display = ('id','thumbnail','place_title','country','location','architecture','sea_level','no_of_visitors','is_recommended')
    list_display_links = ('id','thumbnail','place_title')
    search_fields = ('place_title','id','location','country')
    list_filter = ('location','country','architecture','is_recommended')
